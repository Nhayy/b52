    ...
    ws.on('message', (message) => {
        try {
            ...
            if (cmd === 1003 && gBB) {
                ...
                console.log(`Phiên ${currentSessionId}: ${total} (${resultText}) | Lịch sử: ${sessionHistory.length} phiên`);
...
app.get('/', (req, res) => {
    res.send(`<h2>🎯 Lịch sử Sunwin Tài Xỉu</h2><p><a href="/sunlon">Xem lịch sử JSON tại /sunlon</a></p>`);
});
